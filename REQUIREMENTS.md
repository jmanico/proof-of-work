...
- **External integrations:** None at runtime — the system is self-contained. The bundled nutrition dataset (FR-8.11) is imported at build time, and AI inference for nutrition estimation runs on infrastructure inside the system's own cloud boundary (FR-8.13); no third-party application service receives user data
