...
- **AI Inference (in-boundary)**
  ...
  - **Open decisions:** Concrete model service (managed in-account vs. self-hosted) and its sizing — TO BE DECIDED with the AWS topology (SECURITY.md SQ-7).
