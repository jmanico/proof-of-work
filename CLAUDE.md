...
- **CI platform and pipeline:** GitHub Actions is the platform, using OIDC federation to AWS IAM roles rather than static keys (SEC-CICD-1). Pipeline design, the merge-blocking gate set (SEC-CICD-4), secret-management service, and AWS service topology remain TO BE DECIDED (SECURITY.md SQ-7; `.planning/github-issues/ISSUE_PLAN.md` PQ-19).
