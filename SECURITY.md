...
- **SQ-4** What is the concrete ABAC attribute schema, policy language, and enforcement architecture, and how do capabilities relate to the three fixed roles? The notes select ABAC plus capability-based access control, but REQUIREMENTS.md describes role- and ownership-based rules; the mapping between them is undefined; consultant capabilities themselves are now specified (REQUIREMENTS.md OQ-12 RESOLVED, FR-11.6).
