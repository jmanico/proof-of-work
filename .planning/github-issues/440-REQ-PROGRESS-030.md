...
- **Required Test Environment**: A subscriber identity, forms for each unblocked log type, assistive-technology testing capability. Vitest as the runner, with Playwright and axe-core where a real browser is required.
