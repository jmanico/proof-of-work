...
- **PQ-17 — Abuse-prevention thresholds.** `SECURITY.md` SQ-3, SEC-AUTHN-6, SEC-HTTP-5. Rate limits, exponential-backoff thresholds and delays (fixed lockout is ruled out by SEC-AUTHN-6), anti-automation. Blocks: SEC-AUTHN-6, SEC-HTTP-5, and all alerting fields across every issue. Threats TM-S-1, TM-D-1 CONDITIONAL; TM-D-2 is MITIGATED BY RULE.
